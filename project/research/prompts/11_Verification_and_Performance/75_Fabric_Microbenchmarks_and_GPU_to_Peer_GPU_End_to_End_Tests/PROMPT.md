# Research Agent Prompt — 75: Fabric Microbenchmarks and GPU-to-Peer-GPU End-to-End Tests
...
Research and build the wiki section **75: Fabric Microbenchmarks and GPU-to-Peer-GPU End-to-End Tests**.

**Required coverage:** Define tests for each cable and both cables at relevant message sizes and queue depths, including RTT percentiles, unidirectional and bidirectional bandwidth, CPU cost, interrupts, errors, and contention. Include the decisive GPU-write to peer-GPU-consume path with synchronization and concurrent decode/NVMe workloads.
...
```text
11_Verification_and_Performance/75_Fabric_Microbenchmarks_and_GPU_to_Peer_GPU_End_to_End_Tests/
```
