# Research Agent Prompt — 38: Distributed Runtime Goals, Cost Model, and Mode Selection
...
Research and build the wiki section **38: Distributed Runtime Goals, Cost Model, and Mode Selection**.

**Required coverage:** Define latency, throughput, and capacity objectives and a quantitative cost model for replication, remote speculation, tensor parallelism, pipeline parallelism, and MoE hybrid execution. Include compute, collective, transfer, queueing, cache, and jitter terms plus break-even rules based on p99 measurements rather than theoretical bandwidth.
...
```text
07_Distributed_Runtime/38_Distributed_Runtime_Goals_Cost_Model_and_Mode_Selection/
```
