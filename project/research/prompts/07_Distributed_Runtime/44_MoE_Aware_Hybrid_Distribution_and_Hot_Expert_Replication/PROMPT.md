# Research Agent Prompt — 44: MoE-Aware Hybrid Distribution and Hot-Expert Replication
...
Research and build the wiki section **44: MoE-Aware Hybrid Distribution and Hot-Expert Replication**.

**Required coverage:** Design a two-node MoE plan combining attention sharding or layer pipeline with static expert placement, telemetry-driven balancing, hot-expert replication, cold-expert partitioning, shared experts, router placement, reconfiguration boundaries, and memory constraints. Compare hidden-vector exchange with token-wise all-to-all designs.
...
```text
07_Distributed_Runtime/44_MoE_Aware_Hybrid_Distribution_and_Hot_Expert_Replication/
```
