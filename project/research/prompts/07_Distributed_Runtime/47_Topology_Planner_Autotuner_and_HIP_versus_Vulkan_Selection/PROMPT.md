# Research Agent Prompt — 47: Topology Planner, Autotuner, and HIP-versus-Vulkan Selection
...
Research and build the wiki section **47: Topology Planner, Autotuner, and HIP-versus-Vulkan Selection**.

**Required coverage:** Design the planner that benchmarks and selects execution mode, split points, backend, collective policy, cache layout, MTP settings, batch sizes, and power profile per model and objective. Define input measurements, confidence rules, safety margins, plan manifests, retuning triggers, rollback, and avoidance of overfitting.
...
```text
07_Distributed_Runtime/47_Topology_Planner_Autotuner_and_HIP_versus_Vulkan_Selection/
```
