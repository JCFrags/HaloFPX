# Research Agent Prompt — 20: USB4 Physical Topology and Dual-Port Independence
...
Research and build the wiki section **20: USB4 Physical Topology and Dual-Port Independence**.

**Required coverage:** Research USB4/Thunderbolt host-to-host topology on the exact systems: domains, NHI controllers, retimers, lane sharing, PCIe roots, interrupt routing, link generations, cable capabilities, security levels, and Linux device representation. Define tests to prove whether the two ports provide independent bandwidth and latency under simultaneous load.
...
```text
04_Hardware_and_OS_Platform/20_USB4_Physical_Topology_and_Dual_Port_Independence/
```
