# Research Agent Prompt — 18: Exact Machine BOM, BIOS, Firmware, Cabling, and Revisions
...
Research and build the wiki section **18: Exact Machine BOM, BIOS, Firmware, Cabling, and Revisions**.

**Required coverage:** Define a reproducible inventory for both machines: vendor and model, motherboard revision, RAM configuration, NVMe devices, USB4 controllers, BIOS settings, firmware versions, cables, power supplies, cooling, kernel-visible device IDs, and physical port labels. Provide a data-collection checklist and comparison table for confirming the pair is truly matched.
...
```text
04_Hardware_and_OS_Platform/18_Exact_Machine_BOM_BIOS_Firmware_Cabling_and_Revisions/
```
