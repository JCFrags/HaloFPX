# Research Agent Prompt — 03: Glossary, Naming, and Stable Identifiers
...
Research and build the wiki section **03: Glossary, Naming, and Stable Identifiers**.

**Required coverage:** Create the controlled vocabulary for HaloFPX, ROCmFPX, CachyLLama, llama-ai, llama.cpp, ranks, nodes, execution modes, caches, transports, model formats, performance metrics, and hardware components. Define naming conventions, abbreviations, aliases, filename rules, and stable identifiers used across code, logs, manifests, tests, and wiki pages.
...
```text
01_Wiki_Governance/03_Glossary_Naming_and_Stable_Identifiers/
```
