# Research Agent Prompt — 01: Wiki Architecture, Navigation, and Root Manifest
...
Research and build the wiki section **01: Wiki Architecture, Navigation, and Root Manifest**.

**Required coverage:** Define the complete wiki information architecture, directory tree, root index, stable section IDs, cross-linking rules, ownership fields, status fields, archive policy, and how Codex should discover authoritative material. Include a proposed root manifest schema and rules that prevent duplicate or contradictory pages.
...
```text
01_Wiki_Governance/01_Wiki_Architecture_Navigation_and_Root_Manifest/
```
