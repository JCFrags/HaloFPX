# Research Agent Prompt — 68: Model Lifecycle, Session Lifecycle, Admission Control, and Routing
...
Research and build the wiki section **68: Model Lifecycle, Session Lifecycle, Admission Control, and Routing**.

**Required coverage:** Specify model discovery, preload, shard validation, warmup, unload, replacement, memory reservations, session creation, continuation, expiry, cancellation, ownership, migration, admission control, queueing, user caps, routing, degraded operation, and model-specific plan selection.
...
```text
10_Product_Server_and_Operations/68_Model_Lifecycle_Session_Lifecycle_Admission_Control_and_Routing/
```
