# Research Agent Prompt — 70: Packaging, systemd, Containers, Deployment, and Cold-Boot Procedure
...
Research and build the wiki section **70: Packaging, systemd, Containers, Deployment, and Cold-Boot Procedure**.

**Required coverage:** Design installation artifacts, native packages, self-contained runtimes, optional containers, kernel prerequisites, system users, directories, permissions, systemd units, dependency ordering, network and USB4 setup, service discovery, startup health gates, model preload, cache recovery, uninstallation, and fully reproducible cold boot.
...
```text
10_Product_Server_and_Operations/70_Packaging_systemd_Containers_Deployment_and_Cold_Boot_Procedure/
```
