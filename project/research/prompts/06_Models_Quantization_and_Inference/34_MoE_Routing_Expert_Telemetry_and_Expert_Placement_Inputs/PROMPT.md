# Research Agent Prompt — 34: MoE Routing, Expert Telemetry, and Expert Placement Inputs
...
Research and build the wiki section **34: MoE Routing, Expert Telemetry, and Expert Placement Inputs**.

**Required coverage:** Document router computation, top-k selection, shared experts, expert tensor structure, active-parameter cost, batch behavior, current llama.cpp MoE kernels, CachyLLama expert telemetry, and model-specific routing patterns. Define the telemetry and statistics needed to balance experts and decide which hot experts to replicate.
...
```text
06_Models_Quantization_and_Inference/34_MoE_Routing_Expert_Telemetry_and_Expert_Placement_Inputs/
```
