# Research Agent Prompt — 29: Target Model Catalog and Architecture Support Matrix
...
Research and build the wiki section **29: Target Model Catalog and Architecture Support Matrix**.

**Required coverage:** Build a model catalog for intended dense, MoE, GQA, MLA, sliding-window, Mamba, SSM, hybrid, MTP, coding, tool-use, and long-context models. Record architecture, parameter count, active parameters, layers, hidden size, heads, context, weight size by quant, KV bytes per token, special state, license, conversion status, backend support, and validation status.
...
```text
06_Models_Quantization_and_Inference/29_Target_Model_Catalog_and_Architecture_Support_Matrix/
```
