# Research Agent Prompt — 37: gfx1151 HIP and Vulkan Kernel Optimization Opportunities
...
Research and build the wiki section **37: gfx1151 HIP and Vulkan Kernel Optimization Opportunities**.

**Required coverage:** Create a prioritized kernel optimization map for prompt fill and decode: ROCmFPX dequant GEMV/GEMM, fused QKV, RoPE, attention, row-parallel reductions, residual and normalization fusion, FFN gate/up/down, MoE kernels, MTP verification, graph reuse, memory layout, launch overhead, and architecture-specific vector/subgroup tuning.
...
```text
06_Models_Quantization_and_Inference/37_gfx1151_HIP_and_Vulkan_Kernel_Optimization_Opportunities/
```
