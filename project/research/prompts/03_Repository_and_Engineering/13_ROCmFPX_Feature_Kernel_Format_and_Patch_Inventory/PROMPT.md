# Research Agent Prompt — 13: ROCmFPX Feature, Kernel, Format, and Patch Inventory
...
Research and build the wiki section **13: ROCmFPX Feature, Kernel, Format, and Patch Inventory**.

**Required coverage:** Inventory ROCmFPX weight types, quantization presets, CPU references, HIP kernels, Vulkan kernels, MTP support, TurboQuant KV support, conversion scripts, model capability detection, serving wrappers, tests, benchmarks, and project-specific patches. Note maturity, dependencies, known limitations, and likely conflicts with upstream.
...
```text
03_Repository_and_Engineering/13_ROCmFPX_Feature_Kernel_Format_and_Patch_Inventory/
```
