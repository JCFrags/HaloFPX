# Research Agent Prompt — 08: Scope, Non-Goals, Boundaries, and External Dependencies
...
Research and build the wiki section **08: Scope, Non-Goals, Boundaries, and External Dependencies**.

**Required coverage:** Define included capabilities, explicit non-goals, operating-system scope, hardware scope, supported deployment shapes, upstream dependencies, optional features, prohibited assumptions, and boundaries between HaloFPX, llama.cpp, ROCmFPX, the kernel, model tooling, storage, and client applications.
...
```text
02_Project_Definition/08_Scope_Non_Goals_Boundaries_and_External_Dependencies/
```
