# Research Agent Prompt — 25: Vulkan, RADV, Host-Visible Memory, and Synchronization
...
Research and build the wiki section **25: Vulkan, RADV, Host-Visible Memory, and Synchronization**.

**Required coverage:** Research RADV/Vulkan support relevant to inference: memory heaps and types, coherent and cached host-visible memory, external memory, timeline semaphores, buffer device addresses, command reuse, descriptor overhead, pipeline caching, shader compilation, subgroup features, and synchronization. Compare feasibility with HIP for distributed token-path execution.
...
```text
05_Performance_Software_and_Tools/25_Vulkan_RADV_Host_Visible_Memory_and_Synchronization/
```
