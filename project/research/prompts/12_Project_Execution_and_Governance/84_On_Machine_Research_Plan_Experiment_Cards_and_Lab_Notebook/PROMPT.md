# Research Agent Prompt — 84: On-Machine Research Plan, Experiment Cards, and Lab Notebook
...
Research and build the wiki section **84: On-Machine Research Plan, Experiment Cards, and Lab Notebook**.

**Required coverage:** Define the sequence of physical measurements required before architecture choices are finalized. Provide standardized experiment cards with hypothesis, setup, commands, environment snapshot, variables, controls, raw outputs, analysis, conclusion, confidence, follow-up, and links to decisions. Include a two-host synchronized lab notebook structure.
...
```text
12_Project_Execution_and_Governance/84_On_Machine_Research_Plan_Experiment_Cards_and_Lab_Notebook/
```
