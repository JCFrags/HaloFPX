# Research Agent Prompt — 50: USB4STREAM and thunderbolt-net Implementation Options
...
Research and build the wiki section **50: USB4STREAM and thunderbolt-net Implementation Options**.

**Required coverage:** Document Linux USB4 host-to-host networking and direct USB4STREAM interfaces, device discovery, configfs setup, HopIDs, ring size, interrupt throttling, frame limits, read/write/poll semantics, security authorization, coexistence, kernel versions, and operational setup. Compare direct streams with TCP over thunderbolt-net for the project.
...
```text
08_Fabric_and_Transport/50_USB4STREAM_and_thunderbolt_net_Implementation_Options/
```
