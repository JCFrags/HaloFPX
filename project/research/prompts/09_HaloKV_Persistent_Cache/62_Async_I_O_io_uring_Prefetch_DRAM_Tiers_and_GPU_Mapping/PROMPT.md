# Research Agent Prompt — 62: Async I/O, io_uring, Prefetch, DRAM Tiers, and GPU Mapping
...
Research and build the wiki section **62: Async I/O, io_uring, Prefetch, DRAM Tiers, and GPU Mapping**.

**Required coverage:** Design nonblocking read and write pipelines, io_uring usage, buffered versus direct I/O, registered buffers, read-ahead, prefetch triggered by tokenization, writeback after streaming begins, memory budgets, active and warm DRAM tiers, page-cache residency, GPU mapping, cancellation, queue depth, and contention control.
...
```text
09_HaloKV_Persistent_Cache/62_Async_I_O_io_uring_Prefetch_DRAM_Tiers_and_GPU_Mapping/
```
