# Research Agent Prompt — 56: CachyLLama Cache Semantics and Porting Map
...
Research and build the wiki section **56: CachyLLama Cache Semantics and Porting Map**.

**Required coverage:** Map every CachyLLama cache behavior to retain, redesign, or reject: conversation checkpoints, system-prompt cache, prefix matching, hot/warm/cold tiers, slot lookup, continuation discovery, user namespaces, retention, prefetch, compatibility hashes, MTP/speculative blobs, and recurrent-state handling. Identify source files and integration hooks.
...
```text
09_HaloKV_Persistent_Cache/56_CachyLLama_Cache_Semantics_and_Porting_Map/
```
