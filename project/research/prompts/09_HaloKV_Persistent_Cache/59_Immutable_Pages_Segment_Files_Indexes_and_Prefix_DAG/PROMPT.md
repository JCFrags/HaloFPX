# Research Agent Prompt — 59: Immutable Pages, Segment Files, Indexes, and Prefix DAG
...
Research and build the wiki section **59: Immutable Pages, Segment Files, Indexes, and Prefix DAG**.

**Required coverage:** Design the on-disk data model: page sizing, alignment, immutable extents, append-only segments, headers, checksums, indexes, WAL or journal, token ranges, parent links, prefix radix tree or DAG, copy-on-write branches, segment compaction, mmap versus I/O, and crash-safe publication. Include format diagrams and schemas.
...
```text
09_HaloKV_Persistent_Cache/59_Immutable_Pages_Segment_Files_Indexes_and_Prefix_DAG/
```
