# Research Agent Prompt — 64: Eviction, Garbage Collection, Quotas, User Isolation, and Privacy
...
Research and build the wiki section **64: Eviction, Garbage Collection, Quotas, User Isolation, and Privacy**.

**Required coverage:** Design reachability and recency-based eviction, segment garbage collection, storage budgets, per-model and per-user quotas, pinned prefixes, active-session protection, write amplification limits, background work throttling, tenant namespaces, secure deletion expectations, observability, and behavior under disk pressure.
...
```text
09_HaloKV_Persistent_Cache/64_Eviction_Garbage_Collection_Quotas_User_Isolation_and_Privacy/
```
