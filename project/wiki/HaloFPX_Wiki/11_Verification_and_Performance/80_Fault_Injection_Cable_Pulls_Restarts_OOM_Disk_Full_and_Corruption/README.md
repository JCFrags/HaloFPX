...
This section is a proposed destructive-test plan. No planned injection was performed during research. An accidental production HMM/global-OOM incident was observed on 2026-08-12 and is preserved as safety/recovery evidence [S80-08]; it is not an authorized fault-injection result or benchmark. Run planned cases only on an isolated test deployment with copied models, disposable cache/storage, out-of-band access, explicit targets, and a rehearsed reset path.
