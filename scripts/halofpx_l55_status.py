...
RECORD = re.compile(
    ...
    r"(?:\|subreason=(?P<subreason>backend_ordinal_out_of_range|split_mapping_missing|receipt_invalid_argument|receipt_backend_not_rpc|receipt_context_missing|receipt_status_not_executed|receipt_graph_uid_zero|receipt_execution_sequence_zero|receipt_reason_out_of_range|graph_uid_mismatch|execution_sequence_mismatch)"
    r"\|expected_parent_uid=\d+\|expected_split_uid=\d+\|actual_receipt_uid=\d+"
