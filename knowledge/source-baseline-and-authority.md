...
| ROCmFPX implementation candidate | `61f2f2d7bc4955e9bca821095ef69125837133b5` | **[RECOMMENDATION]** Preferred candidate because its direct-child TurboQuant change avoids unconditional full-cache F16 staging. **[OPEN]** `OPEN-PIN-01` requires matched correctness, build, resource, and performance qualification on both gfx1151 nodes before approval. [Delta review](../reviews/intake/2026-07-17__rocmfpx-pin-to-head-delta__review__v01.md) |
...
- **[RECOMMENDATION]** Keep `a5605a...` immutable as the research control while qualifying `61f2f2d...` as the implementation candidate. If the newer commit fails a mandatory case, retain the control temporarily and repair or disable the affected lane; do not silently advance or discard the bounded-staging requirement.
