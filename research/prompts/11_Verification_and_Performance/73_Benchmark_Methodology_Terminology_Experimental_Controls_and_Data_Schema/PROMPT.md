# Research Agent Prompt — 73: Benchmark Methodology, Terminology, Experimental Controls, and Data Schema
...
Research and build the wiki section **73: Benchmark Methodology, Terminology, Experimental Controls, and Data Schema**.

**Required coverage:** Define TTFT, prompt throughput, generation throughput, inter-token latency, request latency, acceptance rate, cache hit metrics, collective latency, utilization, power, and tail percentiles. Specify warmup, repetitions, confidence intervals, matched settings, model hashes, prompt sets, sampling, environmental controls, raw-data schema, and reporting rules.
...
```text
11_Verification_and_Performance/73_Benchmark_Methodology_Terminology_Experimental_Controls_and_Data_Schema/
```
