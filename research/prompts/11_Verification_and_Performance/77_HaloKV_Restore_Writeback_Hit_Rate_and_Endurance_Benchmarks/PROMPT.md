# Research Agent Prompt — 77: HaloKV Restore, Writeback, Hit-Rate, and Endurance Benchmarks
...
Research and build the wiki section **77: HaloKV Restore, Writeback, Hit-Rate, and Endurance Benchmarks**.

**Required coverage:** Define cache tests for system prefixes, conversation continuations, page sizes, lookup, cold/warm restore, parallel rank reads, dirty-tail writeback, durability modes, garbage collection, disk pressure, concurrent decode, long contexts, hit-rate traces, write amplification, power loss, and SSD endurance.
...
```text
11_Verification_and_Performance/77_HaloKV_Restore_Writeback_Hit_Rate_and_Endurance_Benchmarks/
```
