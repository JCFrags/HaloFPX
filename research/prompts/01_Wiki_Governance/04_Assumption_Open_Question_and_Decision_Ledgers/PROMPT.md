# Research Agent Prompt — 04: Assumption, Open-Question, and Decision Ledgers
...
Research and build the wiki section **04: Assumption, Open-Question, and Decision Ledgers**.

**Required coverage:** Design the ledgers for project assumptions, unresolved questions, research tasks, decisions, rejected alternatives, and superseded conclusions. Define fields for owner, confidence, evidence, impact, due condition, validation method, status, and links to ADRs, experiments, issues, and affected wiki sections.
...
```text
01_Wiki_Governance/04_Assumption_Open_Question_and_Decision_Ledgers/
```
