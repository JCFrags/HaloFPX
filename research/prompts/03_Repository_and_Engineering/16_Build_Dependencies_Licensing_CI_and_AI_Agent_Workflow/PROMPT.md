# Research Agent Prompt — 16: Build, Dependencies, Licensing, CI, and AI-Agent Workflow
...
Research and build the wiki section **16: Build, Dependencies, Licensing, CI, and AI-Agent Workflow**.

**Required coverage:** Document build systems, optional backends, compiler requirements, generated files, submodules, third-party dependencies, licenses, notices, CI jobs, regression gates, code style, commit conventions, review rules, and repository instructions for Codex or other coding agents. Include requirements for an append-only AI change log and reproducible build metadata.
...
```text
03_Repository_and_Engineering/16_Build_Dependencies_Licensing_CI_and_AI_Agent_Workflow/
```
