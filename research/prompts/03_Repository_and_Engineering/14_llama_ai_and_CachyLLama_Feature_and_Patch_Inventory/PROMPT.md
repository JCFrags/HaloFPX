# Research Agent Prompt — 14: llama-ai and CachyLLama Feature and Patch Inventory
...
Research and build the wiki section **14: llama-ai and CachyLLama Feature and Patch Inventory**.

**Required coverage:** Inventory persistent SSD KV behavior, system-prompt cache, hot/warm/cold tiers, continuation matching, user isolation, slot affinity, concurrency controls, recurrent and MTP state handling, model profiles, expert telemetry, runner scripts, server changes, tests, and known correctness or performance limitations.
...
```text
03_Repository_and_Engineering/14_llama_ai_and_CachyLLama_Feature_and_Patch_Inventory/
```
