# Research Agent Prompt — 11: Repository Lineage, Branches, Commits, and Frozen Baselines
...
Research and build the wiki section **11: Repository Lineage, Branches, Commits, and Frozen Baselines**.

**Required coverage:** Map the relationships among fewtarius/llama-ai, fewtarius/CachyLLama, charlie12345/ROCmFPX, and ggml-org/llama.cpp. Record default branches, relevant commits, submodules, release tags, divergence, active development areas, and a procedure for freezing reproducible project baselines.
...
```text
03_Repository_and_Engineering/11_Repository_Lineage_Branches_Commits_and_Frozen_Baselines/
```
