# Research Agent Prompt — 86: Issues, Labels, Milestones, ADRs, Code Review, and Contribution Process
...
Research and build the wiki section **86: Issues, Labels, Milestones, ADRs, Code Review, and Contribution Process**.

**Required coverage:** Design project-management conventions for issues, labels, milestones, pull requests, ADRs, experiments, performance claims, review ownership, security reports, release notes, changelogs, contributor setup, coding-agent tasks, documentation updates, and definition of done. Ensure every code change can be traced to requirements, evidence, and tests.
...
```text
12_Project_Execution_and_Governance/86_Issues_Labels_Milestones_ADRs_Code_Review_and_Contribution_Process/
```
