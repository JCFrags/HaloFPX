# Research Agent Prompt — 85: Internet Research Backlog, Upstream Watch, and Knowledge Freshness
...
Research and build the wiki section **85: Internet Research Backlog, Upstream Watch, and Knowledge Freshness**.

**Required coverage:** Create a prioritized research backlog for Linux USB4, ROCm, Mesa, llama.cpp, ROCmFPX, CachyLLama, RCCL, io_uring, model architectures, and hardware errata. Define trusted feeds, watch queries, version-check cadence, stale-page detection, revalidation triggers, and how changed upstream facts propagate into decisions.
...
```text
12_Project_Execution_and_Governance/85_Internet_Research_Backlog_Upstream_Watch_and_Knowledge_Freshness/
```
