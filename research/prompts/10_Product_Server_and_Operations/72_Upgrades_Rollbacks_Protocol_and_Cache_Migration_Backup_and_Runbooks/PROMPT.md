# Research Agent Prompt — 72: Upgrades, Rollbacks, Protocol and Cache Migration, Backup, and Runbooks
...
Research and build the wiki section **72: Upgrades, Rollbacks, Protocol and Cache Migration, Backup, and Runbooks**.

**Required coverage:** Define version compatibility, rolling versus coordinated upgrades, protocol negotiation, model and plan migration, cache format migration, backup scope, rollback, failed-upgrade recovery, data retention, support bundles, incident runbooks, link replacement, disk replacement, worker rebuild, and disaster recovery.
...
```text
10_Product_Server_and_Operations/72_Upgrades_Rollbacks_Protocol_and_Cache_Migration_Backup_and_Runbooks/
```
