# Research Agent Prompt — 66: OpenAI-Compatible API, Server Semantics, and Error Model
...
Research and build the wiki section **66: OpenAI-Compatible API, Server Semantics, and Error Model**.

**Required coverage:** Document required chat, completions, responses, embeddings if included, streaming, tool calling, structured output, model listing, tokenization, health, metrics, and admin endpoints. Define request extensions for user identity, execution objective, cache policy, durability, plan hints, and deterministic testing plus stable errors and retry semantics.
...
```text
10_Product_Server_and_Operations/66_OpenAI_Compatible_API_Server_Semantics_and_Error_Model/
```
