# Research Agent Prompt — 19: Unified Memory, GTT, GPUVM, IOMMU, and Allocation Limits
...
Research and build the wiki section **19: Unified Memory, GTT, GPUVM, IOMMU, and Allocation Limits**.

**Required coverage:** Explain Strix Halo shared memory, BIOS VRAM carve-outs, GTT, TTM, GPUVM, visible VRAM limits, host-pinned memory, page migration, IOMMU behavior, memory accounting, and failure modes. Identify which limits are physical versus mapping policy and define on-machine tests for allocation, bandwidth, faults, and contention.
...
```text
04_Hardware_and_OS_Platform/19_Unified_Memory_GTT_GPUVM_IOMMU_and_Allocation_Limits/
```
