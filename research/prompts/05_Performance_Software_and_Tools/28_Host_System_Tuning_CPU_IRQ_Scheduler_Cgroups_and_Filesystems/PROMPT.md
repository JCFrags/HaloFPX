# Research Agent Prompt — 28: Host System Tuning: CPU, IRQ, Scheduler, Cgroups, and Filesystems
...
Research and build the wiki section **28: Host System Tuning: CPU, IRQ, Scheduler, Cgroups, and Filesystems**.

**Required coverage:** Research and document governors, boost settings, CPU affinity, isolated cores, IRQ affinity, RPS/XPS, scheduler policy, real-time priorities, memory locking, swap, huge pages, dirty-page settings, cgroups, ulimits, filesystem mount options, NVMe queue settings, and service isolation. Require reversible tuning scripts and before/after evidence.
...
```text
05_Performance_Software_and_Tools/28_Host_System_Tuning_CPU_IRQ_Scheduler_Cgroups_and_Filesystems/
```
