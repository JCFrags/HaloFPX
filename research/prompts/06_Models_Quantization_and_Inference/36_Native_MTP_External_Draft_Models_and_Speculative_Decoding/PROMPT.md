# Research Agent Prompt — 36: Native MTP, External Draft Models, and Speculative Decoding
...
Research and build the wiki section **36: Native MTP, External Draft Models, and Speculative Decoding**.

**Required coverage:** Document native MTP/NextN heads, target verification, external draft models, acceptance metrics, context-dependent tuning, sampling constraints, state serialization, multi-rank implications, and workload sensitivity. Define a test matrix comparing no speculation, native MTP, and a second-node draft model with identical quality.
...
```text
06_Models_Quantization_and_Inference/36_Native_MTP_External_Draft_Models_and_Speculative_Decoding/
```
