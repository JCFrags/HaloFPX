# Research Agent Prompt — 07: Users, Workloads, Personas, and Use Cases
...
Research and build the wiki section **07: Users, Workloads, Personas, and Use Cases**.

**Required coverage:** Characterize target users and real workloads: interactive chat, coding agents, tool-calling agents, long-lived conversations, long-context retrieval, batch jobs, multi-user service, model experimentation, and offline operation. Capture prompt length, turn count, concurrency, latency sensitivity, durability needs, privacy needs, and model mix.
...
```text
02_Project_Definition/07_Users_Workloads_Personas_and_Use_Cases/
```
