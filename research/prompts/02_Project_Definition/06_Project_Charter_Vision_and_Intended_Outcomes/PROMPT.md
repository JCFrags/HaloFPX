# Research Agent Prompt — 06: Project Charter, Vision, and Intended Outcomes
...
Research and build the wiki section **06: Project Charter, Vision, and Intended Outcomes**.

**Required coverage:** Document the product vision for the fastest practical local inference stack on two AMD Strix Halo machines, the problem statement, strategic rationale, intended users, expected outcomes, constraints, sponsorship assumptions, and measurable definitions of project success.
...
```text
02_Project_Definition/06_Project_Charter_Vision_and_Intended_Outcomes/
```
