...
expected_head=b59f62e1e34d6a3176d25583ff6d8f311b91e242
...
for suffix in (
    ...
    print(f"PASS: {mode} {suffix} gfx1151 and composed macro contract")
...
trap - EXIT
echo 'PASS: exact pinned GPU-less gfx1151 HIP composed OFF/OFF and ON/ON compile/link'
