...
Shallow filtered clones at the full hashes were compared with `git diff --no-index` and SHA-256 on 2026-07-16. The source identity result is labeled **[VERIFIED]**, because no standalone experiment receipt was retained; no network operation was run.
