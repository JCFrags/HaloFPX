...
if(NOT PUBLICATION_TARGET_REFERENCE_COUNT EQUAL 7)
    message(FATAL_ERROR "publication target reference count changed; review for product linkage")
endif()
if(NOT SERVER_CMAKE MATCHES "target_link_libraries\\(halofpx-context-store-publication PUBLIC halofpx-context-store-anchor\\)")
    message(FATAL_ERROR "publication coordinator must consume the authenticated anchor carrier")
endif()
...
if(NOT PUBLICATION_CPP MATCHES "verified_manifest_digest != request.next.body\\(\\)->selected_manifest_digest")
    message(FATAL_ERROR "verified manifest is not bound to the next anchor")
endif()
if(NOT PUBLICATION_CPP MATCHES "envelope_size" OR NOT PUBLICATION_CPP MATCHES "envelope_digest" OR
   NOT PUBLICATION_CPP MATCHES "envelope_data")
    message(FATAL_ERROR "protected CAS identity must compare exact authenticated envelope bytes and digest")
endif()
if(NOT PUBLICATION_CPP MATCHES "anchor_absent" OR NOT PUBLICATION_CPP MATCHES "bootstrap_required")
    message(FATAL_ERROR "ordinary publication must reject absent-anchor bootstrap")
endif()
